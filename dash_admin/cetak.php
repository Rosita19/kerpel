...
<body onload='window.print()' style="font-family: arial;font-size: 14px;">
        ...
        ?>
            ...
            <p style="font-family: arial;font-size: 9px;position: absolute;margin-left: 35px;margin-top: 80px;width: 93px;height:30px;text-align:center;position: center;float: center"><?php
                ...
                $tahun = date("Y");
                $thn = $tahun+3;
            ?>Berlaku :<br>Selama menjadi siswa</b><br>MAN 1 Lampung Timur </b></p>
            ...
            <table cellspacing="0em" style="margin-top: -10px; padding-left: 150px; position: relative;font-family: arial;font-size: 12px;transition-property: 500px;width: 490px;height: 100px;"> 
                <tr>
                    <td>Nama</td>
                    <td>:</td>
            ...
            <p style="margin-top: -265px;padding-left: 750px;padding-top: 15px;font-size: 14px;"> <b style="font-size: 14px;">TATA TERTIB SEKOLAH</b>
            ...
            <p style="padding-left: 880px;font-family: arial;font-size: 11px;text-align: justify;padding-right: 25px;width: 35%;margin-top: -6px;">Mengetahui,<br><b>Kepala Madrasah<br><br><br><br><?php echo $blangko["kepsek"];?><br><?php echo $blangko["nip"];?></b></p>
